...
exports.createComplaint = async (req, res) => {
  try {
    ...
    const { booking, subject, description, priority } = req.body
    ...
    await complaint.populate([
      ...
      { path: "booking", select: "date subject" },
    ])
    ...
    const adminNotifications = admins.map((admin) =>
      notificationService.createNotification({
        ...
        message: `${complaint.student.firstname} ${complaint.student.lastname} filed a complaint about ${complaint.teacher.firstname} ${complaint.teacher.lastname}`,
    ...
    await Promise.all([
      ...
      ...admins.map((admin) =>
        emailService.sendComplaintNotificationEmail(
          ...
          complaint.teacher.firstname,
          complaint.teacher.lastname,
          subject,
          description,
        ),
      ),
...
exports.getComplaints = async (req, res) => {
  try {
    ...
    const complaints = await Complaint.find(query)
      ...
      .populate("teacher", "firstname lastname email")
      .populate("booking", "date subject status")
